  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "portal-expand": "portal-expand 1.2s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "text-split-up": "text-split-up 1s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "text-split-down": "text-split-down 1s cubic-bezier(0.16, 1, 0.3, 1) forwards",
