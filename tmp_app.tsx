...
/** Route-level error boundary wrapper ΓÇö granular recovery per page.
...
function PageViewTracker() {
  ...
  // an authenticated user hitting '/' triggers: '/' view ΓåÆ redirect to '/home' ΓåÆ
...
/** H2-FIX: Clears the React Query cache on ANY authΓåÆunauth transition.
                  ...
                  <PageTransition>
                    <ErrorBoundary boundary="LazyRoutes">
                      <Suspense fallback={<FullPageLoader />}>
                        ...
                        {/* Dev-only test route ΓÇö excluded from production builds */}
                        ...
                        {/* Module routes ΓÇö publicly viewable, actions restricted to authenticated users */}
